...
module.exports = {
  ...
  networks: {
    ...
    // Comment this stuff if you want to disable auto block mining. Then blocks will be mined with each trancsaction
    // hardhat: {
    //   mining: {
    //     auto: true,
    //     interval: 3000
  ...
  etherscan: {
    ...
    apiKey: "" // testnet bscscan api // cannot apply for real api key
  }
};
